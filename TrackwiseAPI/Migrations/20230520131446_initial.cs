    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4642), "Ordered", 2897.0 },
                    { 2, 2, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4657), "Ordered", 2997.0 },
                    { 3, 3, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4659), "Ordered", 2998.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4764), 1, 200.5 },
                    { 2, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4765), 2, 75.200000000000003 },
                    { 3, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4767), 3, 450.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4801), 1, 1, 150.5 },
                    { 2, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4804), 1, 2, 50.0 },
                    { 3, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4805), 2, 3, 75.200000000000003 },
                    { 4, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4807), 3, 1, 200.0 },
                    { 5, new DateTime(2023, 5, 20, 15, 14, 45, 950, DateTimeKind.Local).AddTicks(4808), 3, 2, 250.0 }
                });
