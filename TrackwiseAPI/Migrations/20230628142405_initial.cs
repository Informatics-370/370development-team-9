    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5280), "Ordered", 2897.0 },
                    { 2, 2, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5289), "Ordered", 2997.0 },
                    { 3, 3, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5291), "Ordered", 2998.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5375), 1, 200.5 },
                    { 2, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5377), 2, 75.200000000000003 },
                    { 3, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5378), 3, 450.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5405), 1, 1, 150.5 },
                    { 2, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5409), 1, 2, 50.0 },
                    { 3, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5411), 2, 3, 75.200000000000003 },
                    { 4, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5413), 3, 1, 200.0 },
                    { 5, new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5415), 3, 2, 250.0 }
                });
