    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(909), "Ordered", 2897.0 },
                    { 2, 2, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(919), "Ordered", 2997.0 },
                    { 3, 3, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(920), "Ordered", 2998.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1027), 1, 200.5 },
                    { 2, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1029), 2, 75.200000000000003 },
                    { 3, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1031), 3, 450.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1052), 1, 1, 150.5 },
                    { 2, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1054), 1, 2, 50.0 },
                    { 3, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1055), 2, 3, 75.200000000000003 },
                    { 4, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1057), 3, 1, 200.0 },
                    { 5, new DateTime(2023, 6, 28, 16, 41, 4, 766, DateTimeKind.Local).AddTicks(1061), 3, 2, 250.0 }
                });
