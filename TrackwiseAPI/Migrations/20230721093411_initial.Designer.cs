...
namespace TrackwiseAPI.Migrations
{
    ...
    [Migration("20230721093411_initial")]
            ...
            modelBuilder.Entity("TrackwiseAPI.Models.Entities.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Invoice_number = "1",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4544),
                            Order_ID = "1",
                            Total_Amount = 200.5
                        },
                        new
                        {
                            Invoice_number = "2",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4545),
                            Order_ID = "2",
            ...
            modelBuilder.Entity("TrackwiseAPI.Models.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Order_ID = "1",
                            Customer_ID = "1",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4466),
                            Status = "Ordered",
                            Total = 2897.0
                        },
                        new
                        {
                            Order_ID = "2",
                            Customer_ID = "2",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4479),
                            Status = "Ordered",
                            Total = 2997.0
                        },
                        new
                        {
                            Order_ID = "3",
                            Customer_ID = "3",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4480),
                            Status = "Ordered",
                            Total = 2998.0
                        });
                });
            ...
            modelBuilder.Entity("TrackwiseAPI.Models.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Payment_ID = "1",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4557),
                            Order_ID = "1",
                            Payment_Type_ID = "1",
                            amount_paid = 150.5
                        },
                        ...
                        {
                            Payment_ID = "2",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4558),
                            Order_ID = "1",
                            Payment_Type_ID = "2",
                            amount_paid = 50.0
                        },
                        ...
                        {
                            Payment_ID = "4",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4559),
                            Order_ID = "3",
                            Payment_Type_ID = "1",
                            amount_paid = 200.0
                        },
                        ...
                        {
                            Payment_ID = "5",
                            Date = new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4560),
                            Order_ID = "3",
                            Payment_Type_ID = "2",
                            amount_paid = 250.0
                        });
