...
namespace TrackwiseAPI.Migrations
{
    ...
    [Migration("20230628142405_initial")]
            ...
            modelBuilder.Entity("TrackwiseAPI.Models.Entities.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Invoice_number = 1,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5375),
                            Order_ID = 1,
                            Total_Amount = 200.5
                        },
                        new
                        {
                            Invoice_number = 2,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5377),
                            Order_ID = 2,
                        ...
                        {
                            Invoice_number = 3,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5378),
                            Order_ID = 3,
                            Total_Amount = 450.0
                        });
                });
            ...
            modelBuilder.Entity("TrackwiseAPI.Models.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Order_ID = 1,
                            Customer_ID = 1,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5280),
                            Status = "Ordered",
                            Total = 2897.0
                        },
                        new
                        {
                            Order_ID = 2,
                            Customer_ID = 2,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5289),
                            Status = "Ordered",
                            Total = 2997.0
                        },
                        new
                        {
                            Order_ID = 3,
                            Customer_ID = 3,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5291),
                            Status = "Ordered",
                            Total = 2998.0
                        });
                });
            ...
            modelBuilder.Entity("TrackwiseAPI.Models.Entities.Payment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Payment_ID = 1,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5405),
                            Order_ID = 1,
                            Payment_Type_ID = 1,
                            amount_paid = 150.5
                        },
                        ...
                        {
                            Payment_ID = 2,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5409),
                            Order_ID = 1,
                            Payment_Type_ID = 2,
                            amount_paid = 50.0
                        },
                        ...
                        {
                            Payment_ID = 3,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5411),
                            Order_ID = 2,
                            Payment_Type_ID = 3,
                        ...
                        {
                            Payment_ID = 4,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5413),
                            Order_ID = 3,
                            Payment_Type_ID = 1,
                            amount_paid = 200.0
                        },
                        ...
                        {
                            Payment_ID = 5,
                            Date = new DateTime(2023, 6, 28, 16, 24, 5, 517, DateTimeKind.Local).AddTicks(5415),
                            Order_ID = 3,
                            Payment_Type_ID = 2,
                            amount_paid = 250.0
                        });
