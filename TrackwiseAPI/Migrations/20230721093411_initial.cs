    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4466), "Ordered", 2897.0 },
                    { "2", "2", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4479), "Ordered", 2997.0 },
                    { "3", "3", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4480), "Ordered", 2998.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4544), "1", 200.5 },
                    { "2", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4545), "2", 75.200000000000003 },
                    { "3", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4545), "3", 450.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4557), "1", "1", 150.5 },
                    { "2", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4558), "1", "2", 50.0 },
                    { "3", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4558), "2", "3", 75.200000000000003 },
                    { "4", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4559), "3", "1", 200.0 },
                    { "5", new DateTime(2023, 7, 21, 11, 34, 11, 169, DateTimeKind.Local).AddTicks(4560), "3", "2", 250.0 }
                });
